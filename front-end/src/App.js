    ...
    <BrowserRouter>
      <div className="App">
        ...
        <Routes>
          ...
          <Route
            path="/allposts"
            element={<AllPosts posts={posts} companies={companies} />}
          />
          <Route
            path="/posts/:searchValue"
            element={<Posts posts={posts} companies={companies} />}
          />
          <Route
          ...
          <Route
            path="/post/:id"
            element={<PostDetails companies={companies} />}
          />
          <Route
            path="/favorites"
            element={<Favorites posts={posts} companies={companies} />}
          />
        </Routes>
      </div>
    </BrowserRouter>
