...
//   const { id } = useParams(); // الحصول على المعرف من عنوان URL
//   const [userProfile, setUserProfile] = useState({});

//   useEffect(() => {
//     const fetchProfile = async () => {
//       try {
//        // const response = await axios.get(`/employeeProfile/${id}`);
...
//         (formData.profilePicture === userProfile.profilePic || formData.profilePicture instanceof File) &&
//         (formData.resume === userProfile.resume || formData.resume instanceof File)
//       ) {
...
//                 >
//                   {!formData.profilePicture && `${userProfile.firstName.charAt(0)}${userProfile.lastName.charAt(0)}`}
//                 </Avatar>
...
//   const { id } = useParams(); // الحصول على المعرف من عنوان URL
//   const [userProfile, setUserProfile] = useState(null); // تغيير القيم الافتراضية إلى null
//   const [isEditing, setIsEditing] = useState(false);
...
//         });
//         console.log("get data successful", response.data);
//         console.log(response.data._id , currentUser)
...
//                 <Avatar
//                   sx={{ width: 150, height: 150, bgcolor: "secondary.main", mb: 2 }}
//                   src={formData.profilePicture ? URL.createObjectURL(formData.profilePicture) : null}
//                 >
//                   {!formData.profilePicture && `${userProfile.firstName.charAt(0)}${userProfile.lastName.charAt(0)}`}
//                 </Avatar>
//                 <Typography component="h1" variant="h4" align="center" gutterBottom>
